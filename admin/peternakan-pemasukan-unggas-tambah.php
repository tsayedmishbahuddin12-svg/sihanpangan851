...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO peternakan_pemasukan_unggas (keterangan, tanggal, telur_butir, harga, total, tahun) 
            VALUES ('$keterangan', '$tanggal', $telur_butir, $harga, $total, $tahun)";
    
    if ($conn->query($sql)) {
        header('Location: peternakan-pemasukan-unggas.php?success=added');
        exit;
    } else {
...
<head>
    ...
    <title>Tambah Pemasukan Unggas - Admin</title>
            ...
            <div class="content-area">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="peternakan-pemasukan-unggas.php" class="btn btn-secondary">← Kembali</a>
                    </div>
                    <div class="card-body">
                        <form method="POST">
                            <div class="form-group">
                                ...
                                <textarea name="keterangan" required class="form-control" rows="2" 
                                          placeholder="Contoh: PENJUALAN TELUR AYAM"></textarea>
                            </div>
