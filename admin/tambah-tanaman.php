...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        $error = 'Gagal menambahkan tanaman: ' . $conn->error;
    }
}

// Get pleton list (only Pertanian - kategori_id = 1)
$pletons = $conn->query("SELECT p.*, k.nama as kategori_nama FROM pleton p JOIN kategori k ON p.kategori_id = k.id WHERE k.id = 1 ORDER BY p.urutan");
...
<head>
    ...
    <title>Tambah Tanaman - SIHANPANGAN851</title>
...
<body>
    <div class="admin-layout">
        ...
        <div class="main-content">
            <div class="topbar">
                <h1>Tambah Tanaman Pertanian</h1>
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data">
                                ...
                                <select name="pleton_id" required>
                                    ...
                                    <?php while ($pleton = $pletons->fetch_assoc()): ?>
                                        <option value="<?= $pleton['id'] ?>">
                                            <?= $pleton['kategori_nama'] ?> - <?= $pleton['nama'] ?>
                                        </option>
                                    <?php endwhile; ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" required placeholder="Contoh: Padi Gogo">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi" rows="4" placeholder="Deskripsi singkat tentang tanaman..."></textarea>
                            </div>
