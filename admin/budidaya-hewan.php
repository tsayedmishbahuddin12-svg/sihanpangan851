...
// Get hewan info
$hewan = $conn->query("SELECT t.*, p.nama as pleton_nama FROM tanaman t JOIN pleton p ON t.pleton_id = p.id WHERE t.id = $tanaman_id")->fetch_assoc();
...
<head>
    ...
    <title>Data Budidaya - <?= htmlspecialchars($hewan['nama']) ?></title>
...
<body>
    <div class="admin-layout">
        ...
        <div class="main-content">
            <div class="topbar">
                <h1>Data Budidaya: <?= htmlspecialchars($hewan['nama']) ?></h1>
                        ...
                        <form method="POST">
                            ...
                            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1rem;">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kegiatan" required placeholder="Contoh: Pemberian Pakan">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="luas" placeholder="Contoh: 100 m²">
                                </div>
                                
                                <div class="form-group">
                                    <label>Populasi</label>
                                    <input type="text" name="populasi" placeholder="Contoh: 500 ekor">
                                </div>
                                
                                <div class="form-group">
                                    <label>Hasil</label>
                                    <input type="text" name="hasil" placeholder="Contoh: 2 Ton">
                                </div>
                    ...
                    <div class="card-header">
                        ...
                        <div style="display: flex; gap: 0.5rem; align-items: center;">
                            <form method="GET" style="display: flex; gap: 0.5rem;">
                                ...
                                <a href="budidaya-hewan.php?id=<?= $tanaman_id ?>" class="btn btn-reset btn-sm">Reset</a>
                            </form>
                        </div>
                    </div>
                    <div class="card-body">
